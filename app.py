...
app.layout = html.Div([
    ...
    #description
    html.Div(children= "This is a tool that allows for direct comparison of individual NBA teams and players through barplots and scatterplots. The barplot is designed to allow for direct comparisons of statistics between two individual teams and two players. The scatterplot allows for comparison of all NBA teams or players by default; and optional customization to compare as many NBA teams or players as desired."),
    #add dataframe
    html.H2(children="Team Data"),
    dash_table.DataTable(data=team_data.to_dict("records"), page_size=6),

    #dropdown options
    html.H2(children="Team Comparison"),
    html.Label(children="Choose a Season:"),
    dcc.Dropdown(options=["2018-2019","2019-2020", "2020-2021", "2021-2022", "2022-2023"], value="2022-2023", id="season-chosen"),
    html.Label(children="Choose Two Teams to Compare:"),
    dcc.Dropdown(options=['Atlanta Hawks', 'Boston Celtics', 'Brooklyn Nets', 'Charlotte Hornets', 'Chicago Bulls', 'Cleveland Cavaliers', 'Dallas Mavericks', 'Denver Nuggets', 'Detroit Pistons', 'Golden State Warriors', 'Houston Rockets', 'Indiana Pacers', 'Los Angeles Clippers', 'Los Angeles Lakers', 'Memphis Grizzlies', 'Miami Heat', 'Milwaukee Bucks', 'Minnesota Timberwolves', 'New Orleans Pelicans', 'New York Knicks', 'Oklahoma City Thunder', 'Orlando Magic', 'Philadelphia 76ers', 'Phoenix Suns', 'Portland Trail Blazers', 'Sacramento Kings', 'San Antonio Spurs', 'Toronto Raptors', 'Utah Jazz', 'Washington Wizards'], 
                        value="Milwaukee Bucks", id="team-1"),
    dcc.Dropdown(options=['Atlanta Hawks', 'Boston Celtics', 'Brooklyn Nets', 'Charlotte Hornets', 'Chicago Bulls', 'Cleveland Cavaliers', 'Dallas Mavericks', 'Denver Nuggets', 'Detroit Pistons', 'Golden State Warriors', 'Houston Rockets', 'Indiana Pacers', 'Los Angeles Clippers', 'Los Angeles Lakers', 'Memphis Grizzlies', 'Miami Heat', 'Milwaukee Bucks', 'Minnesota Timberwolves', 'New Orleans Pelicans', 'New York Knicks', 'Oklahoma City Thunder', 'Orlando Magic', 'Philadelphia 76ers', 'Phoenix Suns', 'Portland Trail Blazers', 'Sacramento Kings', 'San Antonio Spurs', 'Toronto Raptors', 'Utah Jazz', 'Washington Wizards'], 
                        value="Boston Celtics", id="team-2"),
    html.Label(children="Choose a Statistical Category:"),
    ...
    #scatterplot
    html.H2(children="Assess Relationships Between Statistical Categories for Each Team"),
    html.Div(children="Note: To remove any teams, single-click on the team in the legend. To isolate a specific team, double-click on the team and then single click on additional teams you would like to include. Double-click to reset to default."),
    html.Label(children="Choose a Season:"),
    dcc.Dropdown(options=["2018-2019","2019-2020", "2020-2021", "2021-2022", "2022-2023"], value="2022-2023", id="scatter-season"),
    html.Label(children="Choose Two Different Statistical Categories:"),
    dcc.Dropdown(options=["FGA","FG%","3P","3P%","2P","2P%","FT","FT%","ORB","TRB","AST","STL","BLK","TOV","PF","PTS"],
    ...
    dcc.Graph(figure={}, id="player-bar-graph"),

    #player stat scatterplot
    html.H2(children="Assess Relationships Between Two Statistical Categories Among All Players"),
    html.Div(children="Note: To remove a player, single-click on the player in the legend. To isolate a player, double-click on the player and then single click on additional players you would like to include. Double-click to reset to default."),
    html.Label(children="Choose Two Statistical Categories:"),
    dcc.Dropdown(options = ["AGE","GP","MPG","USG%","TO%","FTA","FT%","2PA","2P%","3PA","3P%","eFG%","TS%","PPG","RPG","APG","SPG","BPG","TPG","P+R","P+A","P+R+A","VI","ORtg","DRtg"],
                value="PPG", id="player-scatter-var-1"),
    dcc.Dropdown(options = ["AGE","GP","MPG","USG%","TO%","FTA","FT%","2PA","2P%","3PA","3P%","eFG%","TS%","PPG","RPG","APG","SPG","BPG","TPG","P+R","P+A","P+R+A","VI","ORtg","DRtg"],
                value="RPG", id="player-scatter-var-2"),
    dcc.Graph(figure={}, id="player-scatter-graph"),
